...
const TEMPLATES = [
  { id: 'turnovers', label: (g:string)=> `${g}: Total team turnovers`, min: 0, max: 6, step: 1 },
  { id: 'sacks', label: (g:string)=> `${g}: Total team sacks`, min: 0, max: 10, step: 1 },
  { id: 'passYds', label: (g:string)=> `${g}: QB passing yards`, min: 100, max: 450, step: 5, units: 'yds' },
  { id: 'rushYds', label: (g:string)=> `${g}: RB rushing yards`, min: 0, max: 220, step: 5, units: 'yds' },
  { id: 'recYds', label: (g:string)=> `${g}: WR receiving yards`, min: 0, max: 220, step: 5, units: 'yds' },
  { id: 'longFG', label: (g:string)=> `${g}: Longest field goal`, min: 20, max: 65, step: 1, units: 'yds' },
];
